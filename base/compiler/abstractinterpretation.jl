...
function abstract_eval_statement(interp::AbstractInterpreter, @nospecialize(e), vtypes::VarTable, sv::InferenceState)
    ...
    elseif ehead === :new
        ...
        if isconcretedispatch(t)
            ...
            elseif ismutable
                ...
                consistent = CONSISTENT_IFNOTRETURNED
            else
    ...
    elseif ehead === :splatnew
        ...
        consistent = !ismutabletype(t) ? ALWAYS_TRUE : CONSISTENT_IFNOTRETURNED
        merge_effects!(sv, Effects(EFFECTS_TOTAL; consistent, nothrow))
    ...
    elseif ehead === :foreigncall
        ...
        if isa(cconv, QuoteNode) && (v = cconv.value; isa(v, Tuple{Symbol, UInt8}))
            ...
            effects = Effects(
                ...
                override.noglobal            ? true       : effects.noglobal,
...
function abstract_eval_global(M::Module, s::Symbol, frame::InferenceState)
    ...
    merge_effects!(frame, Effects(EFFECTS_TOTAL; consistent, nothrow, noglobal))
    return rt
end
...
function handle_global_assignment!(interp::AbstractInterpreter, frame::InferenceState, lhs::GlobalRef, @nospecialize(newty))
    ...
    noglobal = false
    merge_effects!(frame, Effects(EFFECTS_TOTAL; effect_free, nothrow, noglobal))
    return nothing
end
